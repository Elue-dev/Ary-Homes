...
export default function AddBlogPost() {
  ...
  const addBlogToDatabase = (e) => {
    ...
    if (!topics.includes(blogPost.category)) {
      window.scrollTo(0, 0);
      setShowAlert(true);
      setAlertMessage(
        `Your blog post is not under any of the specified categories/topics`
      );
      setAlertType("error");
      window.setTimeout(() => {
        setShowAlert(false);
  ...
  return (
    ...
    >
      ...
      <p className="post__info">
        {user.displayName}, your blog post should be on one of the following
        categories/topics:
        <div>
          <b>Real Estate, Lifestyle, Work Life or Personal Development.</b>
        </div>
        <p
          onClick={() => navigate(-1)}
      ...
      <div className="add__a__blog__post">
        <form onSubmit={addBlogToDatabase}>
          ...
          <label>
            ...
            <input
              ...
              onChange={(e) => handleInputChange(e)}
              placeholder="Name that will appear on blog post eg John Adewale"
              required
            />
          </label>
          <br />
          ...
          <label>
            ...
            <textarea
              ...
              onChange={(e) => handleInputChange(e)}
              placeholder="Enter details of the blog post here..."
              rerquiredcols="30"
              rows="10"
              required
            />
